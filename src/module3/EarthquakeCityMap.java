...
public class EarthquakeCityMap extends PApplet {
	...
	public void setup() {
		...
		if (offline) {
			...
			map = new UnfoldingMap(this, 200, 50, 700, 500, new MapBox.BlankProvider());
	...
	*/
	...
	{	
		...
		fill(152);
		rect(30, 20, 150, 250, 7);
		fill(255,255,255);
		textSize(12);
		text("Earthquake key", 35, 60);
		text("5.0+ Magnitude", 55, 90); 
		text("4.0+ Magnitude", 55, 150);
		text("Below 4.0", 55, 210);
		fill(255,0,0);
		ellipse(35, 90, 27, 27);
		fill(255,255,0);
